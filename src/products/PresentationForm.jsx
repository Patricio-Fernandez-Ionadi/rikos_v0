...
export const PresentationForm = ({ initial, onSubmit, onCancel }) => {
  ...
  return (
    <form className="product-form" onSubmit={handleSubmit}>
      ...
      <input className="field-input" type="text" value={label} onChange={(e) => setLabel(e.target.value)} autoFocus />

      <label className="field-label">Gramos</label>
      <input className="field-input" type="number" value={grams} onChange={(e) => setGrams(e.target.value)} />
      ...
      <input className="field-input" type="number" value={salePrice} onChange={(e) => setSalePrice(e.target.value)} />

      <label className="field-label">Stock inicial</label>
      <input className="field-input" type="number" value={stock} onChange={(e) => setStock(e.target.value)} />
