...
export const ShiftSalesList = () => {
  ...
  return (
    <div className="shift-sales">
      <h4 className="shift-sales__title">Ventas del turno ({sales.length})</h4>
      {sales.length === 0 ? (
              ...
              {editing === sale._tempId ? (
                <div className="shift-sales__edit">
                  ...
                  <span className="shift-sales__total">
                    ${(parseFloat(editQty || 0) * parseFloat(editPrice || 0)).toLocaleString()}
                  </span>
                ...
                <div className="shift-sales__display">
                  ...
                  <span className="shift-sales__qty">{sale.quantity}u</span>
